'''
To run the Bokeh server hosting the API, use the ``bokeh serve`` command.
...
# Plot total fit of combined model
...
# Update model parameters, rerun model and update plot
